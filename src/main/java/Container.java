...
class Container {
    ...
    final static Map<Integer, List<KeyboardButton>> buttonContainer = Map.of(1, List.of(new KeyboardButton("Информация"), new KeyboardButton("Язык")),
            2, List.of(new KeyboardButton("Sendler.Information"), new KeyboardButton("Language")),
            3, List.of(new KeyboardButton("Sendler.Information"), new KeyboardButton("Spranche")));
